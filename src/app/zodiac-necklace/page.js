    ...
    return ( 
        <div className="p-3 sm:p-10  flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
                <h1 className="NorthernTerritories text-[28px] max-sm:text-[24px]">Zodiac Necklace</h1>
                <h3 className="max-sm:text-[14px]">Looking for a stunning piece of jewelry to elevate your look and showcase your personality? Look no further than our Zodiac Necklace collection!</h3>
                <h3 className="max-sm:text-[14px]">Crafted with exquisite attention to detail and quality, our Zodiac Necklaces feature a delicate chain and a beautiful pendant adorned with your zodiac sign. Wear it as a standalone statement piece. </h3>
            </div>
