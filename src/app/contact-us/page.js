        ...
        <div className="flex justify-center py-10 px-3">
            <div className="w-[650px] flex flex-col gap-8">
                <div className="flex flex-col gap-8 w-full items-center justify-center">
                    <h1 className="NorthernTerritories text-[28px] max-sm:text-[20px]">WE'RE HERE To HELp</h1>
                    <p className="capitalize text-[15px] leading-loose max-sm:leading-normal">Still have a question? We’re happy to answer any questions you might have! Please fill out the form below or send us an email to  support@bayrite.com. Just make sure to check out our <span className="text-[#e2b808]">FAQ page</span> - stypically the answers to most questions are right there!</p>
                </div>
