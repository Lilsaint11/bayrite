    ...
    return ( 
        <div className="p-10 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
                <h1 className="NorthernTerritories text-[28px]">Gemstone Necklace</h1>
                <h3>Elevate your gifting with our exquisite Gemstone Collection. Each piece is a masterpiece, capturing the beauty of genuine gemstones. Radiate emotions with colors that tell a story. Crafted with timeless design and unmatched quality, it's a gift they'll cherish forever. Redefine luxury – explore the brilliance of our Gemstone Collection today.</h3>
                <h2 className="text-[20px] text-[#4d4d4d] font-bold italic">Life Time Warranty on OUR  Gemstone</h2>
            </div>
