    ...
    return ( 
        <div className="p-3 sm:p-10 flex flex-col gap-5">
            ...
            <div className="flex gap-2 items-center">
                ...
                <h3 className="text-[#5c5c5c]">Gifting</h3>
            </div>
            <div className="flex flex-col gap-4">
                <h1 className="NorthernTerritories text-[28px] max-sm:text-[24px]">Gifting</h1>
            </div>
            <div className="flex flex-col gap-4 w-full items-center justify-center max-sm:mt-5">
                <h1 className="NorthernTerritories text-[20px] max-sm:text-[18px]">FIND YoUR MAGICAL GIFT</h1>
                <p className="capitalize text-[15px]">With our simple buying guide</p>
            </div>
